...
## 🌍 Contexte du Projet
*   **Objectif** : Permettre aux gens de faire du shopping en ligne plus simplement et en toute sécurité.

## 🚀 Fonctionnalités
*   **Authentification** : Inscription, Connexion sécurisée.
*   **Scan & Analyse** : Recherche par image via API.
*   **Filtres éco-responsables** : Detection Scam vs Eco.
...
---
*Projet réalisé par Snapfit dans le cadre de la S3.01.*
